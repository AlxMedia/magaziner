<?php
function magaziner_get_meta_box( $meta_boxes ) {
...
/* ------------------------------------ */	
	$meta_boxes[] = array(
		'id' => 'page-options',
		'title' => esc_html__( 'Page Options', 'magaziner' ),
		...
		'fields' => array(
			array(
				...
				'name' => esc_html__( 'Primary Sidebar', 'magaziner' ),
				'type' => 'select',
			...
			array(
				...
				'name' => esc_html__( 'Secondary Sidebar', 'magaziner' ),
				'type' => 'select',
				'placeholder' => esc_html__( 'Select a sidebar', 'magaziner' ),
				'options' => $sidebars_choices,
			),
			array(
				'id' => $prefix . 'layout',
				'type' => 'image_select',
				'name' => esc_html__( 'Layout', 'magaziner' ),
				'std' => 'inherit',
				'force_delete' => false,
				'max_file_uploads' => '4',
				'options' => array(
...
/* ------------------------------------ */	
	$meta_boxes[] = array(
		'id' => 'post-options',
		'title' => esc_html__( 'Post Options', 'magaziner' ),
...
add_filter( 'rwmb_meta_boxes', 'magaziner_get_meta_box' );
